...
class preprocess_prediction_data:
    """
    ...
    def __init__(self, aws_operations=None, logger=None):
        self.log_file = 'prediction_logs/prediction_data_preprocessing_log.txt'
    ...
    def remove_columns(self, data, columns_to_remove):
        """
        Method to remove the given columns from the prediction data.
        ...
        On Failure:
            raise Exception
        """
        self.logger.log(self.log_file, 'Removing the given columns from the prediction data!')
        try:
    ...
    def separate_features_and_label(self, data, label_column_name):
        """
        Method to separate the features and the label in the prediction data.
        ...
        On Failure:
            raise Exception
        """
        self.logger.log(self.log_file, 'Separating features and label in the prediction data!')
        try:
    ...
    def is_null_present(self, data):
        """
        Method to check whether NULL values are present in the prediction data.
        ...
        On Failure:
            raise Exception
        """
        self.logger.log(self.log_file, 'Checking for NULL values in the prediction data!')
        try:
    ...
    def impute_missing_values(self, data):
        """
        Method to replace all the missing values in the prediction data using a KNN Imputer.
        ...
        On Failure:
            raise Exception
        """
        message = 'Imputing missing values in the prediction data using a KNN imputer!'
        self.logger.log(self.log_file, message)
        try:
    ...
    def columns_with_zero_standard_deviation(self, data):
        """
        Method to find the columns in the prediction data which have a standard deviation of zero.
        ...
        On Failure:
            raise Exception
        """
        message = 'Checking for columns in the prediction data with zero standard deviation!'
        self.logger.log(self.log_file, message)
        try:
