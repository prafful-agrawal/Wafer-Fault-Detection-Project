...
class transform_training_data:
    """
    This class shall be used for transforming the good training data before loading it in a database.
    ...
    def __init__(self, good_data_path, bad_data_path, aws_operations=None, logger=None):
        ...
        self.log_file = 'training_logs/training_data_transformation_log.txt'
    ...
    def replace_missing_values_with_null(self):
        """
        Method to replace missing values with 'NULL' to store the training data in the database.
    ...
    def format_wafer_column(self):
        """
        Method to format the 'Wafer' column in the training data.
        The first column is missing its name in the .CSV files. So, this method renames
        the unnamed column to 'Wafer' column. Also, the substring 'Wafer' is dropped
